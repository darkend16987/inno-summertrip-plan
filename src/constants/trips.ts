...
export const TRIPS: Trip[] = [
  {
    ...
    budgetVal: 10,
    budgetLabel: '10 củ',
    description: 'Đổi không khí văn phòng lấy gió biển mát lành — Vũng Tàu chờ cả team xả hơi! Hải sản tươi rồi, nắng vàng ươm và tiếng sóng vỗ đúng kiểu "chill tận linh hồn". Tất cả gói gọn trong 10 củ, không cần suy nghĩ nhiều!',
  ...
  },
  {
    ...
    description: 'Khám phá xứ sở Kim Chi từ Busan năng động đến Seoul rực rỡ and Incheon hiện đại. Một hành trình 6 ngày 5 đêm trọn vẹn văn hóa, ẩm thực và mua sắm dành cho các tín đồ K-Culture!',
